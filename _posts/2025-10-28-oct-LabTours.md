...
<img align="right" width="400" src="{{site.baseurl}}/assets/images/monthly_posters/2025-10-28_osoh_rb_oct-poster-portrait.png">


### Labs Showcased
<orange>The WHITE Lab, NeuroDataScience-ORIGAMI, Trenholm Lab, MiND Lab, Fournier Lab, NeuroSPEED, Origami<br></orange>
...
<orange>When</orange>
Tuesday, October 28, 2026 at 9-3 pm EST

<orange>Where</orange>
The Neuro<br>

<orange>Abstract</orange>
The Open Science Office Hours (OSOH) is running a special thematic month featuring open‑source/open-science tools developed at The Neuro/McGill.
Our goal is twofold: (1) help open‑science contributors have their work recognized, and (2) help trainees learn how to adapt open‑source tools in their own research.
